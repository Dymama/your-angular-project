...
export class AssignmentsService {
  ...
  assignments: Assignment[] = [
    {
      ...
      matieres:'',
      image:'',
      enseignant_nom: 'Gabriel Mopolo',
      enseignant_photo:'https://www.windows8facile.fr/wp-content/uploads/2017/10/oracle-logo.jpg',
      auteur:'YEDE Eunice',
      note:0,
    ...
    },
    {
      ...
      image:'',
      enseignant_nom: 'Gabriel Mopolo',
      enseignant_photo:'https://i.vimeocdn.com/video/802035881_1280x720.jpg',
      auteur:'Youan bi Toussaint',
      note:0,
      remarques:'Aucune remarque'
  ...
  url = 'https://mamayouan.herokuapp.com/api/assignments';
